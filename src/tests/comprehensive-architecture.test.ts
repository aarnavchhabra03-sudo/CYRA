...
export async function runComprehensiveTests() {
  ...
  const mockSnapshot: LearnerStateSnapshot = {
    ...
    mastery: [
      { concept: 'Cell Membrane', masteryScore: 25, effectiveMasteryScore: 25, daysSinceReview: 0, reviewNeeded: true, retentionFactor: 1.0, questionsAttempted: 5, questionsCorrect: 1, lastResult: 'weak', lessonId: 'lesson-1' }
    ],
    recommendations: [],
    adaptivePlan: [],
    rootGaps: [],
